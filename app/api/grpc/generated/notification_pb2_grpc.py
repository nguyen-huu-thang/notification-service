...
from app.api.grpc.generated import notification_pb2 as notification__pb2
...
class NotificationServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.SendEmail = channel.unary_unary(
                ...
                response_deserializer=notification__pb2.SendEmailResponse.FromString,
...
def add_NotificationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SendEmail': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=notification__pb2.SendEmailResponse.SerializeToString,
            ),
    }
...
class NotificationService:
    ...
    def SendEmail(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/notification.NotificationService/SendEmail',
            notification__pb2.SendEmailRequest.SerializeToString,
            notification__pb2.SendEmailResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
